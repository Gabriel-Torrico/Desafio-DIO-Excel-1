...
- INICIALIZAÇÃO
- [Etapa 1: Inicialização e Visualização](#etapa-1-inicialização-e-visualização)
...
[📊 Baixar planilha Excel](ProjetoEXCEL/Desafio_Excel_DIO-Ferramenta_de_investimentos-1.xlsx)
